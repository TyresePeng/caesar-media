...
public interface FansClubDataOrBuilder extends
   ...
   * @return The badge.
   */
  org.caesar.crawler.live.douyin.codec.protobuf.UserBadge getBadge();
  /**
   * <code>.UserBadge badge = 4;</code>
   */
  org.caesar.crawler.live.douyin.codec.protobuf.UserBadgeOrBuilder getBadgeOrBuilder();

  /**
   * <code>repeated int64 availableGiftIds = 5;</code>
   * @return A list containing the availableGiftIds.
   */
  java.util.List<Long> getAvailableGiftIdsList();
  /**
   * <code>repeated int64 availableGiftIds = 5;</code>
